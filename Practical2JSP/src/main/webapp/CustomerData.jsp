...
<input type="text" name="CutomerName" /><br>
<label for="CustomerEmailAddress">Email Address: </label>
<input type="text" name="CustomerEmailAddress" /><br>
<label for="CutomerPhoneNo">Phone No: </label>
<input type="text" name="CutomerPhoneNo" /><br>
