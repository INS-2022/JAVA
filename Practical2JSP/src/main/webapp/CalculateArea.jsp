...
<body>
	<form action="getArea.jsp">
		...
		%>
		<h1>Enter dimensions for <%=request.getParameter("shape") %></h1>
		
		<input type="text" name="shape" hidden="true" value="<%=request.getParameter("shape") %>">
		<label for="dim1">Enter Dimension 1: </label> 
		<input type="number" name="dim1"></input>
		<br>
		<%
